function D = BuildDiffusionMatrix2Periodic(parts,Eta_m,Kappa,kT,boxSize)
...
for i = 1:2:2*N
    D(i:i+1,i:i+1) = BuildDiffusionMatrixSelf(Eta_m,Kappa,kT,boxSize);
end
end

function [D] = BuildDiffusionMatrixInteraction(r1,r20,Eta_m,Kappa,kT,boxSize)
%coder.extrinsic('bessely');
...
function [D] = BuildDiffusionMatrixSelf(Eta_m,Kappa,kT,boxSize)
